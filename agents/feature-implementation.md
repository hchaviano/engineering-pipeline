...
Do not launch `verify` or any other pipeline subagent. The parent owns Quality Gate. Implement only the current Implementation Phase; set its Status to `done` when green.
